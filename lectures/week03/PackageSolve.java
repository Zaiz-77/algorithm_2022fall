...
public class PackageSolve {
     ...
     */
    public int ZeroOnePackage1(int capacity, int[] ws, int[] vs) {
        int n = ws.length;
     ...
     * @return the max earnings
     */
    public int ZeroOnePackage2(int capacity, int[] ws, int[] vs) {
        int n = ws.length;
    ...
    public static void main(String[] args) {
        ...
        System.out.println(solve.ZeroOnePackage1(9, ws, vs));
        System.out.println(solve.ZeroOnePackage2(9, ws, vs));
    }
}
